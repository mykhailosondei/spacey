...
const ListingHolder : React.FC = () => {
    return (
        <>
            ...
            <ListingBox title={"Crosslake, Minnesota, US"} distance={"420 km away"} availability={"Yes"} price={400} rating={4.96} pictures={['/mansion1.jpg', '/mansion1_1.jpg', '/mansion2.jpg']}></ListingBox>
